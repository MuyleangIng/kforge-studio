#############################################################################
# Makefile for building: kforge-studio.app/Contents/MacOS/kforge-studio
# Generated by qmake (3.1) (Qt 6.10.2)
# Project:  kforge-studio.pro
# Template: app
# Command: /opt/homebrew/opt/qt/bin/qmake -o Makefile kforge-studio.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = kforge-studio1.0.0
DISTDIR = /Users/ingmuyleang/Downloads/files\ (2)/.tmp/kforge-studio1.0.0
...
SOURCES       = main.cpp \
		...
		SidebarWidget.cpp \
		BuildJobWidget.cpp \
		OtherWidgets.cpp moc_MainWindow.cpp \
		moc_SidebarWidget.cpp \
		moc_BuildJobWidget.cpp \
		moc_OtherWidgets.cpp
OBJECTS       = main.o \
		MainWindow.o \
		SidebarWidget.o \
		BuildJobWidget.o \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		kforge-studio.pro BuildJob.h \
		MainWindow.h \
		SidebarWidget.h \
		BuildJobWidget.h \
		OtherWidgets.h main.cpp \
		MainWindow.cpp \
		SidebarWidget.cpp \
		BuildJobWidget.cpp \
		OtherWidgets.cpp
QMAKE_TARGET  = kforge-studio
DESTDIR       = 
TARGET        = kforge-studio.app/Contents/MacOS/kforge-studio

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.4
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/ingmuyleang/Downloads/files (2)/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/ingmuyleang/Downloads/files (2)/kforge-studio.pro
...
kforge-studio.app/Contents/MacOS/kforge-studio:  $(OBJECTS)  
	@test -d kforge-studio.app/Contents/MacOS/ || mkdir -p kforge-studio.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: kforge-studio.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile kforge-studio.pro
...
kforge-studio.app/Contents/PkgInfo: 
	@test -d kforge-studio.app/Contents || mkdir -p kforge-studio.app/Contents
	@$(DEL_FILE) kforge-studio.app/Contents/PkgInfo
	@echo "APPL????" > kforge-studio.app/Contents/PkgInfo
kforge-studio.app/Contents/Info.plist: 
	@test -d kforge-studio.app/Contents || mkdir -p kforge-studio.app/Contents
	@$(DEL_FILE) kforge-studio.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.kforge-studio,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.kforge-studio,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,kforge-studio,g" -e "s,@LIBRARY@,kforge-studio,g" -e "s,\$${EXECUTABLE_NAME},kforge-studio,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >kforge-studio.app/Contents/Info.plist

all: Makefile \
		kforge-studio.app/Contents/PkgInfo \
		kforge-studio.app/Contents/Info.plist kforge-studio.app/Contents/MacOS/kforge-studio
...
distdir: FORCE
	...
	$(COPY_FILE) --parents BuildJob.h MainWindow.h SidebarWidget.h BuildJobWidget.h OtherWidgets.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp MainWindow.cpp SidebarWidget.cpp BuildJobWidget.cpp OtherWidgets.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_SidebarWidget.cpp moc_BuildJobWidget.cpp moc_OtherWidgets.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_SidebarWidget.cpp moc_BuildJobWidget.cpp moc_OtherWidgets.cpp
moc_MainWindow.cpp: MainWindow.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/ingmuyleang/Downloads/files (2)/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/ingmuyleang/Downloads/files (2)' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib MainWindow.h -o moc_MainWindow.cpp

moc_SidebarWidget.cpp: SidebarWidget.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/ingmuyleang/Downloads/files (2)/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/ingmuyleang/Downloads/files (2)' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib SidebarWidget.h -o moc_SidebarWidget.cpp

moc_BuildJobWidget.cpp: BuildJobWidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QMap \
		/opt/homebrew/lib/QtCore.framework/Headers/qmap.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/ingmuyleang/Downloads/files (2)/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/ingmuyleang/Downloads/files (2)' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib BuildJobWidget.h -o moc_BuildJobWidget.cpp

moc_OtherWidgets.cpp: OtherWidgets.h \
		BuildJob.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QStringList \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/ingmuyleang/Downloads/files (2)/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/ingmuyleang/Downloads/files (2)' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib OtherWidgets.h -o moc_OtherWidgets.cpp
...
SidebarWidget.o: SidebarWidget.cpp SidebarWidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QButtonGroup \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qbuttongroup.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SidebarWidget.o SidebarWidget.cpp

BuildJobWidget.o: BuildJobWidget.cpp BuildJobWidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QMap \
		/opt/homebrew/lib/QtCore.framework/Headers/qmap.h \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/QFrame \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qframe.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o BuildJobWidget.o BuildJobWidget.cpp

OtherWidgets.o: OtherWidgets.cpp OtherWidgets.h \
		BuildJob.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QStringList \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDateTime \
		/opt/homebrew/lib/QtCore.framework/Headers/qdatetime.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o OtherWidgets.o OtherWidgets.cpp
...
moc_BuildJobWidget.o: moc_BuildJobWidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_BuildJobWidget.o moc_BuildJobWidget.cpp

moc_OtherWidgets.o: moc_OtherWidgets.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_OtherWidgets.o moc_OtherWidgets.cpp
